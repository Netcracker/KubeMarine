...
The `services.zram` section allows you to declare mount points where ZRAM filesystem should (or should not) be mounted.
...
| **size**               | no         | Desired filesystem size (e.g. `1G`), applicable if `state` is `present`. |
...
Affected nodes are gracefully rebooted during the task execution.

The `size` of the ZRAM volume must be selected according to the kubelet configuration. For `1G` case, the following values are recommended and they must be set in the `kubeadm_kubelet` section:
...
|          | registry.k8s.io/kube-controller-manager               | v1.36.0            | v1.36.0               | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            |                                                                                      |
|          | registry.k8s.io/kube-proxy                            | v1.36.0            | v1.36.0               | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            |                                                                                      |
|          | registry.k8s.io/kube-scheduler                        | v1.36.0            | v1.36.0               | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            | v1.36.0            |                                                                                      |
