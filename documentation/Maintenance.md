...
For example, it is not recommended to use networks from deprecated Site-Local scoped address prefix (fec0::/10). It is better to use  Unique Local Unicast range (fc00::/7).
