...
So if you would like to add a custom name to an IP address of a cluster node, it is better to list all names for this node - custom defined and generated by Kubemarine in a desired order.
