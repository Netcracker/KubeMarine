...
from kubemarine.patches.p1_upgrade_crictl_version import UpgrateCrictlVersion
from kubemarine.patches.p2_upgrade_calico_version import UpgrateCalicoVersion

patches: List[Patch] = [
        UpgrateCrictlVersion(),
