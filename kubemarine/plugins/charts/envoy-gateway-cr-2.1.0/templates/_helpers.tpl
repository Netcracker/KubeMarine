...
{{/*
The name of the Envoy image.
*/}}
{{- define "envoy.image" -}}
{{- if .Values.global.images.envoy.image -}}
{{- .Values.global.images.envoy.image }}
{{- else -}}
