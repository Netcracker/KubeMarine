...
def pretty_print_error(reason: Exception, log=None) -> None:
    ...
    if isinstance(reason, GroupException):
        ...
        # GroupException is thrown during remote command execution.
        # Logging system should have been initialized, and we have to use it to properly handle sensitive data.
        if log is None:
            sys.stderr.write("Logging system was not initialized\n")
            return
